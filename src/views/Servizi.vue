  ...
  data() {
    return {
      ...
      cardServiziSection: [
        ...
        {
          image: 'src/assets/img/foto_classic_garage/image00025.jpeg',
        ...
        {
          image: 'src/assets/img/foto_classic_garage/image00029.jpeg',
...
<template>
  <HeroLink title="Servizi" :image="image" />
  <!-- passa l'immagine come props -->

  <section class="body_link servizi">
